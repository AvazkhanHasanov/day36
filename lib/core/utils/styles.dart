...
class AppStyles {
  static final appBarT = TextStyle(
    fontSize: 20.sp,
  ...
  static final tSW500S20Oq = TextStyle(
    fontWeight: FontWeight.w500,
    fontSize: 20,
    color: AppColors.brownF9,
    fontFamily: 'Poppins',
  );
  static final tSW600S20Black = TextStyle(
    fontFamily: 'Poppins',
    fontSize: 20.sp,
    fontWeight: FontWeight.w600,
    color: AppColors.beige,
  );
  static final tSW500S15Black = TextStyle(
    fontFamily: 'Poppins',
    fontSize: 15.sp,
    fontWeight: FontWeight.w500,
    color: AppColors.beige,
  );
  static final tSW500S15 = TextStyle(
    fontFamily: 'Poppins',
    fontSize: 15.sp,
    fontWeight: FontWeight.w500,
  ...
  static final tSW400S12Oq = TextStyle(
    fontWeight: FontWeight.w400,
    fontSize: 12.sp,
    color: AppColors.brownF9,
  );
  static final tSW400S11Oq = TextStyle(
    fontWeight: FontWeight.w400,
    fontSize: 11.sp,
    color: AppColors.brownF9,
  );
  ...
  static  final subtitlePinkC = TextStyle(
    fontSize: 15.sp,
    fontWeight: FontWeight.w500,
    color: AppColors.pinkSubC,
    fontFamily: 'Poppins',
  ...
  static final subTextMiniOq = TextStyle(
    fontSize: 13.sp,
    fontWeight: FontWeight.w300,
    color: AppColors.brownF9,
    fontFamily: 'League',
  );
  static final tSW600S14 = TextStyle(
    fontSize: 14.sp,
    fontWeight: FontWeight.w600,
    color: AppColors.brownF9,
    fontFamily: 'League',
  ...
  static final tSW300S12Oq = TextStyle(
    fontWeight: FontWeight.w300,
    fontSize: 12.sp,
    color: AppColors.brownF9,
    fontFamily: 'Poppins',
  );
  static final tSW300S15Oq = TextStyle(
    fontWeight: FontWeight.w300,
    fontSize: 15.sp,
    color: AppColors.brownF9,
    fontFamily: 'Poppins',
  ...
  static final tSW400S15 = TextStyle(
    fontWeight: FontWeight.w400,
    fontSize: 15.sp,
    color: AppColors.beige,
    fontFamily: 'Poppins',
