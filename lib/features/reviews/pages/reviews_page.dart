        ...
        child: Column(
          children: [
            About(
              ...
              profilePhoto: 'assets/image.png',
              username: 'Andrew-Mar',
              firstName: 'Andrew Martinez',
              rating: 4,
              reviewsCount: 456,
            ...
            Padding(
              ...
              child: Column(
                ...
                Padding(
                  ...
                  child: Text('Comments',style: AppStyles.subtitle,),
                ),
                ...List.generate(
                  4,
                      (index) {
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (index != 1) Padding(
                            ...
                            child: Divider(color: AppColors.redPinkMain,height: 1.h,),
                          ),
                        ],
                      ),
                    );
